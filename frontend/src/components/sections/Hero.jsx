...
const Hero = ({ onGetStarted }) => {
        return (
            <section className="relative min-h-120 w-full bg-cover bg-center bg-center before:absolute before:inset-0 before:bg-black/40 bg-no-repeat flex flex-col items-center justify-center px-6 py-20" 
            style= {{ backgroundImage: "url('/images/hero-bg.jpg')" }}>
                <div className='text-white text-center max-w-xl z-10'>
                    <h1 className='text-3xl md:text-4xl font-bold mb-4 leading-tight'>Explore The World With Ease</h1>
