...
const Hero = ({ onGetStarted }) => {
        return (
            <section className="relative min-h-screen w-full bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center px-6 py-20" 
            style= {{ backgroundImage: "url('/src/assets/hero-bg.jpg')" }}>
                <div className='text-white text-center max-w-xl z-10'>
                    ...
                    className="bg-orange-500 text-white py-3 px-6 md:px-8 rounded-md font-medium hover:scale-105 transition-all duration-300 z-20 relative">
                        Get Started
                    </button>
                </div>
                <Stats />
